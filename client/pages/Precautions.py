...
# def show():
st.header("Precautions for Heart Attack")
st.write("There are several precautions and lifestyle changes that can reduce the risk of heart disease. "
        "These include regular exercise, a balanced diet, maintaining a healthy weight, avoiding smoking and "
